...
namespace Lab4_1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 10; i < 30; i++)
            {
                string path = @"C:\Users\admin\Desktop\Lab 4 files\txtwritefiles" + i + ".txt";
                try
                {
                ...
                {
                    using (StreamWriter no_file = new StreamWriter(@"C:\Users\admin\Desktop\Lab 4 files\txtwritefiles\no_file.txt", false, System.Text.Encoding.Default))
                    {
                ...
                {
                    using (StreamWriter bad_data = new StreamWriter(@"C:\Users\admin\Desktop\Lab 4 files\txtwritefiles\bad_data.txt", false, System.Text.Encoding.Default))
                    {
                ...
                catch (System.OverflowException)
                {
                    ...
                    using (StreamWriter overflow = new StreamWriter(@"CC:\Users\admin\Desktop\Lab 4 files\txtwritefiles\overflow.txt", false, System.Text.Encoding.Default))
                    {
